        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="mailto:info@harmedahealthcare.com" className="flex items-center gap-3 text-gray-300 hover:text-brand-green transition-colors">
                  <Mail size={20} className="flex-shrink-0" />
                  <span className="text-sm">info@harmedahealthcare.com</span>
                </a>
              </li>
              <li>
                <a href="tel:+917888840794" className="flex items-center gap-3 text-gray-300 hover:text-brand-green transition-colors">
                  <Phone size={20} className="flex-shrink-0" />
                  <span className="text-sm">+91-7888840794</span>
                </a>
              </li>
            </ul>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400 text-center md:text-left">
              <span className="text-brand-green font-medium">Harmeda Healthcare</span>, All right reserved.
            </p>
            <button 
              onClick={scrollToTop}
